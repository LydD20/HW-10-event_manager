...
class Settings(BaseSettings):
    ...
    admin_password: str = Field(default='AdminSecret@1234', description="Default admin password")    debug: bool = Field(default=False, description="Debug mode outputs errors and sqlalchemy queries")
